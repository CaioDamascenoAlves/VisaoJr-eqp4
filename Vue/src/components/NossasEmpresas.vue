<template>
  <div>
    ...
    >
      <div
        class="empresa-content"
        :class="{ 'empresa-content-reverse': index % 2 === 0 }"
      >
        <div class="empresa-logo">
          <img
            :src="require(`../assets/empresas/${empresa.logo}`)"
            alt="Logo da Empresa"
          />
        </div>
        <div class="empresa-info">
          ...
          <div class="text-center">
            <b-button
              ...
              squared
              id="botao-content"
              @click="selectEmpresa(index)"
              :style="{
                backgroundColor: empresa.botaoBgColor,
                color: empresa.botaoTextColor,
...
export default {
    ...
    return {
      empresas: [
        ...
        },
        {
          ...
          description:
            "O Happy Hour é um fast food popular, conhecido por oferecer refeições rápidas e saborosas a preços acessíveis. Com um menu diversificado, que inclui hambúrgueres, batatas fritas, sanduíches, saladas e sobremesas, o Happy Hour atende às preferências de diferentes paladares.",
          navbarColor: "#FFAD00",
          textColor: "#ffffff",
          logo: "Teste.png",
        ...
        },
        {
          ...
          subtitle: "DO MERCADO",
          description:
            "A Mach1ne é uma empresa líder no setor de locação de carros, conhecida por sua excelência em serviços e compromisso em oferecer aos clientes uma experiência de locação de veículos de alta qualidade. Com uma ampla frota de carros, que inclui desde modelos econômicos até veículos de luxo, a Mach1ne atende às necessidades de diversos tipos de clientes. ",
          navbarColor: "#58C2EC",
          textColor: "#ffffff",
          logo: "LogoMach.png",
        ...
        },
        {
          ...
          description:
            "A Sky Wings Airlines é uma empresa líder no setor da aviação, oferecendo voos de alta qualidade e confiabilidade. Com uma frota moderna e uma equipe altamente capacitada, eles se destacam por garantir voos seguros, confortáveis e pontuais para os passageiros, proporcionando uma experiência de viagem excepcional. ",
          navbarColor: "#B91AA8",
          textColor: "#ffffff",
          logo: "LogoSky.png",
  ...
  methods: {
    ...mapActions(["setCurrentVariant", "setNavbarColor", "setTextColor"]),
    selectEmpresa(index) {
    ...
    // Add the method to set the initial navbar color when the component mounts
    setInitialNavbarColor() {
      if (this.selectedEmpresa !== null) {
        this.setNavbarColor(this.empresas[this.selectedEmpresa].navbarColor);
        this.setTextColor(this.empresas[this.selectedEmpresa].textColor);
      }
    },
    ...
    // Add the IntersectionObserver to handle navbar color changes
    setupIntersectionObserver() {
      ...
      entries.forEach((entry) => {
        if (
          ...
          entry.target.id === "nossas-empresas" &&
          this.isPageScrolled
        ) {
  ...
  mounted() {
    // Call the method to set the initial navbar color when the component mounts
    this.setInitialNavbarColor();

    // Call the method to set up the IntersectionObserver
